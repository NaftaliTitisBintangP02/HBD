...
const nomor_hp_yang_ngirim = "+6281229324019"
const nama_yang_ngirim = "Bintang"
...
// yang ini biarin aja
let n = 0
const link_wa = `https://api.whatsapp.com/send?text= ${nama_yang_ngirim}&phone=${nomor_hp_yang_ngirim}`
nm.textContent = nama
nm_2.textContent = nama_yang_ngirim

// kata katanya tapi perhatiin tanda `` nya biar enggak eror
const kata = [
  `Selamat ulang tahun yaaa ${nama}, 🎂😘`,
  `Jaga kesehatan jangan begadang teruss 🙃`,
  `Selalu tersenyumm, apapun yang orang lakuin ke kita yaa ${nama}`,
  `Jangan lupa di makan 🍰 nya, walau virtual hehe, kukasih permen ajaa besok lahh`,
  `Sekali lagi happy b'dayyy yaa ${nama} cantik 🥰`
]
